...
namespace FormularioDeMenus
{
    public partial class Cuadros_de_dialogo : Form
    {
        ...
        {
            MessageBox.Show("Probando el botón ACEPTAR", "Ejemplo Mensaje Aceptar");
        }

        private void button2_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Mensaje con los botones ACEPTAR y CANCELAR", "Ejemplo Mensaje OKCanccel", MessageBoxButtons.OKCancel);
        }

        private void button3_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Mensaje con los botones SI, NO y CANCELAR", "Ejemplo Mensaje YesNoCanccel", MessageBoxButtons.YesNoCancel);
        }
